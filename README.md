...
| Today's Date 04/02/2025            |                                                                                                                                                                                                                          |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| What content plan to cover         | Introduction to Object-Oriented Programming (OOP) Concepts, Creating Classes and Objects in C#, Defining and Accessing Class Members (fields, properties, methods), Inheritance and Polymorphism in C#, Interfaces and Abstract Classes in C# |
| What content I actually covered    | Introduction to Object-Oriented Programming (OOP) Concepts, Creating Classes and Objects in C#, Defining and Accessing Class Members (fields, properties, methods), Inheritance and Polymorphism in C#. Started Front-End-Blazor Tutorial.                                                                                                                                                                                                   |
| Reflection on what I learned today |     I really liked using Blazor, it seems very similar to React and I really like that you have a lot of functionality right out of the box when creating a Blazor App.                                                      |
| Reflection on how I learned today  |Today went well, I was not able to cover Interfaces and Abstract Classes in C# but I did enjoy learning Blazor.                                                                                           |
| Reflections for the following day  | I need to find good resource to cover Interfaces and Abstract Classes in C#.

| Today's Date 04/03/2025            |                                                                                                                                                                                                                          |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| What content plan to cover         | TDD, Exception Handling, and File I/O in C#, Test Driven Development in C#, Exception Handling in C#, Handling Exceptions with try-catch Blocks, Reading and Writing Files in C#, Streams and Byte Arrays in C#                    |
| What content I actually covered    |                         Started Back-End Tutorial and created API with GET POST & DELETE routes. Created Test Application, still working on getting the tests to run.                                                               |
...
| Today's Date 04/07/2025            |                                                                                                                                                                                                                          |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| What content plan to cover         | Download .NET, Understand what is .NET Framework, Familiarize yourself with the components of the .NET Framework, such as Common Language Runtime (CLR), Base Class Library (BCL), and Application Domain, Understand the architecture of the .NET Framework, Understand the benefits of using .NET Framework                    |
| What content I actually covered    |                         All of the above. I was able to create a Todo App using Blazor for the front-end and full CRUD back-end. Front-End succesfully sends http requests to back-end to store and retrieve from Database.                                                               |
